...
import (
	...
	"github.com/ohdat/gormt/data/config"
	"github.com/ohdat/gormt/data/view/cnf"
	"github.com/ohdat/gormt/data/view/genfunc"
...
func getTypeName(name string, isNull bool) string {
	...
	panic(fmt.Sprintf("type (%v) not match in any way.maybe need to add on (https://github.com/ohdat/gormt/blob/master/data/view/cnf/def.go)", name))
}
