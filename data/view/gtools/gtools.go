...
import (
	...
	"github.com/ohdat/gormt/data/dlg"
	"github.com/ohdat/gormt/data/view/model"

	"github.com/ohdat/gormt/data/config"

	"github.com/ohdat/gormt/data/view/model/genmysql"
	"github.com/ohdat/gormt/data/view/model/gensqlite"
